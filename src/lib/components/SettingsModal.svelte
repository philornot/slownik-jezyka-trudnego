  ...
  >
    ...
    <div class="p-4 sm:p-6 space-y-5 sm:space-y-6">
      ...
      <div class="space-y-4">
        ...
        <div class="space-y-2">
          <label for="daily-target-input" class="flex items-center justify-between text-xs font-extrabold text-[var(--text-primary)]">
            <span>Nowe słowa na dzienną sesję</span>
            <span class="text-sm font-extrabold text-[var(--text-amber-brand)]">{localSettings.dailyNewWordsLimit}</span>
          </label>
        ...
        <div class="flex items-center justify-between pt-2">
          <div class="space-y-0.5">
            <div class="flex items-center gap-2 text-xs font-extrabold text-[var(--text-primary)]">
              <Icon icon="ph:bell-bold" class="h-4 w-4 text-[var(--brand-primary)]" />
              <span>Powiadomienia o powtórkach</span>
            </div>
            <p class="text-[11px] font-semibold text-[var(--text-muted)]">Codzienne przypomnienie w przeglądarce</p>
          </div>
      ...
      <div class="border-t border-[var(--border-default)] pt-4 sm:pt-5 space-y-4">
        ...
        <div class="flex items-center justify-between">
          <div class="space-y-0.5">
            <div class="flex items-center gap-2 text-xs font-extrabold text-[var(--text-primary)]">
              <Icon icon="ph:sun-dim-bold" class="h-4 w-4 text-[var(--brand-primary)]" />
              <span>Wysoki kontrast</span>
            </div>
            <p class="text-[11px] font-semibold text-[var(--text-muted)]">Wyrazistsze kolory, grubsze obramowania</p>
          </div>
        ...
        <div class="flex items-center justify-between">
          <div class="space-y-0.5">
            <div class="flex items-center gap-2 text-xs font-extrabold text-[var(--text-primary)]">
              <Icon icon="ph:prohibit-bold" class="h-4 w-4 text-[var(--brand-primary)]" />
              <span>Redukcja animacji</span>
            </div>
            <p class="text-[11px] font-semibold text-[var(--text-muted)]">Wyłączenie animacji i przejść</p>
          </div>
      ...
      {#if onResetProgress}
        <div class="border-t border-[var(--border-default)] pt-4 sm:pt-5 space-y-3">
          ...
          {:else}
            ...
            <div class="rounded-xl border border-[var(--rose-border)] bg-[var(--rose-bg)] p-4 space-y-3 animate-in fade-in duration-200">
              <div class="flex items-start gap-2">
                <Icon icon="ph:warning-bold" class="h-5 w-5 shrink-0 text-[var(--rose-icon)] mt-0.5" />
                <div class="text-xs text-[var(--rose-text)]">
                  <p class="font-extrabold">Czy na pewno chcesz zresetować całą historię?</p>
                  <p class="mt-1 text-[11px] font-semibold">Ta operacja usunie wszystkie powtórki i rozpocznie naukę od zera. Nie można jej cofnąć.</p>
                </div>
              </div>
