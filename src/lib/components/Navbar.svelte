...
<!-- ============================== -->
<header
  class="sticky top-0 z-40 border-b border-[var(--border-default)] bg-[var(--bg-app)]/95 backdrop-blur-md shadow-xs transition-colors duration-200 pt-[env(safe-area-inset-top,0px)]"
>
  <div
  ...
  >
    ...
    <div class="flex items-center gap-2.5">
      <div
        class="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[var(--brand-primary)] to-[var(--brand-primary-hover)] shadow-xs shrink-0"
      >
        <Icon
      ...
      <div>
        ...
        <p
          class="hidden sm:block text-xs font-semibold text-[var(--text-muted)]"
        >
    ...
    <nav
      class="hidden sm:flex items-center gap-1 rounded-xl border border-[var(--border-default)] bg-[var(--bg-surface-elevated)] p-1"
    >
      <button
        type="button"
    ...
    <div class="flex items-center gap-1.5 sm:gap-2">
      {#if userEmail}
        ...
        <div
          class="hidden md:flex items-center gap-1.5 rounded-xl border border-[var(--border-default)] bg-[var(--bg-surface-elevated)] px-2.5 py-1 text-xs font-semibold text-[var(--text-secondary)]"
        >
          <Icon
            icon="ph:user-bold"
            class="h-3.5 w-3.5 text-[var(--brand-primary)]"
          />
...
>
  ...
  >
    {#if activeTab === "lesson"}
      <div
        class="absolute top-0 left-1/2 -translate-x-1/2 w-8 h-[3px] bg-[var(--brand-primary)] rounded-b-full shadow-xs"
      ></div>
    {/if}
    <Icon
